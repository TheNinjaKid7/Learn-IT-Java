...
public class Book {
	...
	// Constructor of the superclass (Book)
	public Book() {
	...
	public Book(int id, String name, Author authors[], Publisher publisher, int publishingYear, int amountOfPages,
		...
		// Call to the constructor of the superclass (Book)
		super();
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
        // Use Arrays.hashCode for arrays and Objects.hash for individual fields
    ...
    // Custom method to check if the book has a specific author
